"""
Update Final_Workflow copy.ipynb with v3 export code (full horizontal layout with K values)
"""
import json

# Read the v3 export code
with open('export_2025_10_and_2025_01_v3.py', 'r', encoding='utf-8') as f:
    export_code = f.read()
...
for cell in notebook['cells']:
    if cell['cell_type'] == 'code':
        ...
        if 'EXPORT COHORTS' in source or 'export_cohort_forecast_details' in source:
            print("Found export cell, updating to v3...")
...
print(f"✅ Notebook updated with v3 export code!")
print(f"   Total cells: {len(notebook['cells'])}")
print(f"   Layout: Full horizontal (ngang đầy đủ)")
print(f"\n💡 V3 Layout:")
print(f"   - Row 2-4: Current balance & loans (ngang)")
print(f"   - Row 6-9: K_raw, K_smooth, Alpha (ngang)")
print(f"   - Row 11+: Transition matrices (ngang)")
print(f"   → Có đủ thông tin để tính forecast hoàn chỉnh!")
