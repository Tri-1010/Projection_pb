"""
Script để thêm cell export cohort details vào Final_Workflow copy notebook
"""
import json
...
markdown_cell = {
    ...
    "metadata": {},
    "source": [
        "## 📊 EXPORT CHI TIẾT FORECAST CHO SẾP\n",
        "\n",
        "Export tất cả thông số để tính forecast cho specific cohorts:\n",
        "- Transition matrices\n",
        "- K values (raw, smooth, alpha)\n",
        "- Actual data by MOB\n",
        "- Forecast calculation steps\n",
        "\n",
        "**Output**: File Excel với 6 sheets chi tiết"
    ]
}
...
print(f"✅ Added export cells to notebook")
