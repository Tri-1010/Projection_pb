"""
Code export cohorts với layout ngang (v2)
- Row 2: Current balance và MOB (ngang)
- Row 10+: Transition matrices (ngang)
"""

# ============================================================
# EXPORT TẤT CẢ COHORTS THÁNG 2025-10 VÀ 2025-01 (V2)
# ============================================================

from export_cohort_details_v2 import export_cohort_forecast_details_v2
import pandas as pd
from src.config import parse_date_column

print("="*60)
print("📊 EXPORT COHORTS V2: 2025-10 và 2025-01")
print("   Layout: Ngang (horizontal) để viết công thức Excel")
print("="*60)
...
# ============================
# 2. EXPORT (V2 - HORIZONTAL LAYOUT)
# ============================

if len(all_cohorts) > 0:
    print(f"\n📤 Exporting {len(all_cohorts)} cohorts (v2 layout)...")
    ...
    filename = export_cohort_forecast_details_v2(
        cohorts=all_cohorts,
        df_raw=df_raw,
    ...
    print(f"   → Dễ viết công thức Excel tính ngang!")
